...
const quickQuestions = [
  { id: 1, text: '帮我写一个 Python 脚本计算斐波那契数列', icon: '🐍' },
  { id: 2, text: '搜索一下今天的热点新闻', icon: '🔍' },
  { id: 3, text: '解释什么是机器学习，并用代码示例说明', icon: '🤖' },
  { id: 4, text: '分析这段代码的性能问题：\nfor i in range(len(arr)):\n    for j in range(len(arr)):\n        print(arr[i]+arr[j])', icon: '⚡' },
]

function sendMessage(message, { onMessage, signal }) {
  return chatWithManus(message, { onMessage, signal })
}
...
<template>
  <div class="manus-chat-view">
    ...
    <div class="disclaimer-bar">
      ...
      <span>Manus 是具备工具调用能力的 AI 智能体，可执行代码、搜索信息等。请合理使用。</span>
    </div>
    ...
    <div class="main-layout">
      ...
      <div class="chat-wrapper">
        <ChatRoom
            ref="chatRoomRef"
            title="AI 超级智能体"
            subtitle="具备工具调用能力的 Manus 智能体，每次对话独立实例"
...
/* 响应式：屏幕宽度小于 800px 时，左侧问题栏变成顶部横向滚动条 */
